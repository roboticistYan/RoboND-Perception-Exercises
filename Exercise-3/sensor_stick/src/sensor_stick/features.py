...
def compute_normal_histograms(normal_cloud):
    ...
    hist_x = np.histogram(norm_x_vals, bins=32, range=(0, 256))
    hist_y = np.histogram(norm_y_vals, bins=32, range=(0, 256))
    hist_z = np.histogram(norm_z_vals, bins=32, range=(0, 256))
